      ...
      <div className="container-x grid gap-12 lg:grid-cols-12">
        <div className="lg:col-span-5">
          ...
          <div className="mt-6 flex items-center gap-3">
            <a aria-label="LinkedIn" href={company.socials.linkedin} target="_blank" rel="noreferrer" className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-border/60 transition hover:border-primary/60 hover:text-primary"><Linkedin className="h-4 w-4" /></a>
            <a aria-label="Instagram" href={company.socials.instagram} target="_blank" rel="noreferrer" className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-border/60 transition hover:border-primary/60 hover:text-primary"><Instagram className="h-4 w-4" /></a>
            <a aria-label="YouTube" href={company.socials.youtube} target="_blank" rel="noreferrer" className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-border/60 transition hover:border-primary/60 hover:text-primary"><Youtube className="h-4 w-4" /></a>
          </div>
        </div>
