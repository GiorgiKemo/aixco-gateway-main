        ...
        <div className="lg:col-span-5">
          ...
          <div className="mt-10 space-y-5">
            <a href={`mailto:${company.email}`} className="flex items-start gap-4 group">
              <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl border border-border/60 group-hover:border-primary/60 transition"><Mail className="h-4 w-4 text-primary" /></span>
              <div>
            ...
            <div className="flex items-start gap-4">
              <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl border border-border/60"><MapPin className="h-4 w-4 text-primary" /></span>
              <div>
        ...
        <div className="lg:col-span-7">
          {state === "success" ? (
            <div className="glass p-10 text-center">
              <span className="inline-flex h-14 w-14 items-center justify-center rounded-full bg-primary/10 text-primary mb-5">
            ...
            <form onSubmit={onSubmit} noValidate className="grid gap-6 glass p-7 md:p-10">
